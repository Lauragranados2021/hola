...
<div class="container-fluid alert-secondary text-center">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6"><br>
                <p>Presentado a : <br> - Jairo Riaño.</p>
            </div>
            <p>Universidad Pedagógica y Tecnológica de Colombia - UPTC<br>Ingeniería de sistemas - Seccional Sogamoso<br>Asesoria: Diego Corredor<br>2022 &copy</p>
        </div>
    </div>
</div>
